...
export default function Home() {
  ...
  const allLessons = [...lessons, ...deepLessons].map(l => ({ slug: l.slug, title: l.title, summary: l.summary, category: l.category, href: deepLessons.some(d => d.slug === l.slug) ? `/deep/${l.slug}` : `/learn/${l.slug}` }));
  const progressIds = allLessons.map(l => l.href + ':' + l.slug);
  return (
