...
export default function Home() {
  ...
  const deepLessons = [...advancedLessons, ...advancedExtraLessons, ...advancedNodeLessons];
  return (
    <main className="shell">
      <header className="top">
        <Link href="/" className="brand"><b>JS</b><span>Academy</span></Link>
        <nav aria-label="التنقل الرئيسي"><a href="#courses">الدروس</a><a href="#advanced">المستوى العميق</a><a href="#backend">Backend</a><a href="#about">عن المنهج</a></nav>
        <ThemeToggle />
      </header>
      ...
      <Reveal>
        <section className="hero">
          <div className="hero-copy">
            <span className="eyebrow">JAVASCRIPT → ASYNC → NODE.JS → BACKEND</span>
            <h1>ذاكر JavaScript وNode.js <em>بفهم حقيقي.</em></h1>
            <p>منهج عربي عملي يبدأ من أساسيات JavaScript، ثم Async JavaScript وNode.js، وصولًا إلى HTTP وREST وMiddleware وBackend Architecture — مع المصطلحات والكود والتنفيذ الداخلي والأخطاء والتمارين.</p>
            <div className="actions"><Link className="primary" href={`/learn/${lessons[0].slug}`}>ابدأ المذاكرة <ArrowLeft size={18}/></Link><a className="ghost" href="#courses">استكشف المنهج</a></div>
            <div className="hero-points"><span>✓ شرح عربي واضح</span><span>✓ كود LTR</span><span>✓ تمارين عملية</span></div>
          </div>
          <div className="hero-visual">
            <img src="/hero-code.svg" alt="واجهة كود تعليمية لـ JavaScript وNode.js" />
            <div className="floating-badge badge-one"><Code2 size={15}/> Practice</div>
            <div className="floating-badge badge-two"><Zap size={15}/> Async</div>
          </div>
        </section>
      </Reveal>
